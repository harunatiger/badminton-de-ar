class ListingDetailsController < ApplicationController
  ...
  private
    ...
    def listing_detail_params
      params.require(:listing_detail).permit(:listing_id, :time_required, :price, :option_price, :min_num_of_people, :max_num_of_people, :included, :zipcode, :location, :place, :condition, :refund_policy, :in_case_of_rain)
    end
end
