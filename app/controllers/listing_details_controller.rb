class ListingDetailsController < ApplicationController
  ...
  private
    ...
    def listing_detail_params
      params.require(:listing_detail).permit(:listing_id, :time_required, :price, :price_other, :option_price, :option_price_per_person, :min_num_of_people, :max_num_of_people, :included, :included_other, :zipcode, :location, :place, :place_memo, :condition, :refund_policy, :in_case_of_rain, :place_longitude, :place_latitude)
    end
end
